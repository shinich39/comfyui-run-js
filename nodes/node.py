...
placeholder += "YYYY: string // Years\n"
placeholder += "MM: string // Month\n"
placeholder += "DD: string // Dates\n"
placeholder += "hh: string // Hours\n"
placeholder += "mm: string // Minutes\n"
placeholder += "ss: string // Seconds\n"
